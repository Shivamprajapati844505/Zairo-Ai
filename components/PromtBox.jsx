...
const PromtBox = ({ isLoading, setIsLoading }) => {
 ...
 const sendPrompt = async (e) => {
  ...
  if (!selectedChat?._id) return toast.error("Please select a chat before sending a message");
  ...
  return (
    <form
      onSubmit={sendPrompt} className={`w-full ${ selectedChat?.messages.length > 0 ?"max-w-3xl":"max-w-2xl"
