...
>
  ...
  {expand && <p className="text-white font-medium">New chat</p>}
    ...
    <div className={`mt-8 text-white/250 text-sm ${expand ? "block": "hidden"}`}>
      ...
      <div>
        <div className={`flex items-center cursor-pointer group reltaive ${expand ? " gap-1 text-white/80 text-sm p-2.5 border border-primary rounded-lg hover:bg-white/10 cursor-pointer":"h-10 w-10 mx-auto hover:bg-gray-500/30 rounded-lg"} `}>
            ...
            <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shawdow-lg">
                <Image src={assets.qrcode} alt='' className="w-44"/>
                <p>Scan to get Zairo Ai</p>
